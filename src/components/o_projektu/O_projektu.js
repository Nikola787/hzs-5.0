...
import Is from "../iskustva/iskustva.js";
          ...
          <div className="levi-deo">
            ...
            <div className="levi-prozor-box">
              <p className="centralni_tekst">
                ...
                već petu godinu zaredom organizuje Udruženje studenata
                informatike FONIS na Fakultetu organizacionih nauka. Namenjeno
                je svim srednjoškolcima na teritoriji Republike Srbije.
                <br />
                <br />
                <b>Tročlani ili četvoročlani timovi</b> srednjoškolaca imaju{" "}
                <b>24 sata</b> na raspolaganju da kreiraju softversko rešenje na
                zadatu temu, koju saznaju na sam dan takmičenja. Učesnici će
                tokom hakatona imati podršku <b>mentora</b>, koji će biti tu da
                razreše sve njihove nedoumice i usmere timove.
                <br />
                <br />
                ...
                pokrivaju front-end, back-end, git i veštine prezentovanja i
                čine sastavni deo selekcije takmičara. Cilj ovih radionica je da
                se srednjoškolci bolje pripreme za samo takmičenje i da prošire
